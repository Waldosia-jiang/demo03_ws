...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_server_client_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/plumbing_server_client)
  set(plumbing_server_client_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(plumbing_server_client_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT "/home/wheeltec/demo03_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_server_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/plumbing_server_client/${idir}'.  ${_report}")
    endif()
