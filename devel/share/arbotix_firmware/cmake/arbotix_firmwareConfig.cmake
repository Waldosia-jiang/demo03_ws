...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_firmware_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_firmware)
  set(arbotix_firmware_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(arbotix_firmware_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_firmware/${idir}'.  ${_report}")
    endif()
