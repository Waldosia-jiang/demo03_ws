...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_test_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/plumbing_test)
  set(plumbing_test_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(plumbing_test_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/plumbing_test/${idir}'.  ${_report}")
    endif()
