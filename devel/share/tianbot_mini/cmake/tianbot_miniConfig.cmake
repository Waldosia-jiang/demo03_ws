...
if("TRUE" STREQUAL "TRUE")
  set(tianbot_mini_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/tianbot_mini)
  set(tianbot_mini_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(tianbot_mini_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tianbot_mini' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/tianbot_mini/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tianbot_mini_EXPORTED_TARGETS ${${tianbot_mini_dep}_EXPORTED_TARGETS})
endforeach()
