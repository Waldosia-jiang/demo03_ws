...
if(formation_controller_CONFIG_INCLUDED)
  return()
endif()
set(formation_controller_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(formation_controller_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/formation_controller)
  set(formation_controller_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  set(formation_controller_INSTALL_PREFIX "")
  set(formation_controller_PREFIX ${formation_controller_DEVEL_PREFIX})
else()
  set(formation_controller_SOURCE_PREFIX "")
  set(formation_controller_DEVEL_PREFIX "")
  set(formation_controller_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
  set(formation_controller_PREFIX ${formation_controller_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'formation_controller' is deprecated")
...
set(formation_controller_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/wheeltec/demo03_ws/devel/include " STREQUAL " ")
  set(formation_controller_INCLUDE_DIRS "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${formation_controller_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'formation_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'formation_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/formation_controller/${idir}'.  ${_report}")
    endif()
    _list_append_unique(formation_controller_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND formation_controller_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND formation_controller_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT formation_controller_NUM_DUMMY_TARGETS)
      set(formation_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::formation_controller::wrapped-linker-option${formation_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR formation_controller_NUM_DUMMY_TARGETS "${formation_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::formation_controller::wrapped-linker-option${formation_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND formation_controller_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(formation_controller_LIBRARY_DIRS ${lib_path})
      list(APPEND formation_controller_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'formation_controller'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND formation_controller_LIBRARIES ${lib})
    endif()
  endif()
...
set(formation_controller_EXPORTED_TARGETS "formation_controller_gencfg")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${formation_controller_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 formation_controller_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${formation_controller_dep}_FOUND)
      find_package(${formation_controller_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${formation_controller_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(formation_controller_INCLUDE_DIRS ${${formation_controller_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(formation_controller_LIBRARIES ${formation_controller_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${formation_controller_dep}_LIBRARIES})
  _list_append_deduplicate(formation_controller_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(formation_controller_LIBRARIES ${formation_controller_LIBRARIES})

  _list_append_unique(formation_controller_LIBRARY_DIRS ${${formation_controller_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(formation_controller_EXPORTED_TARGETS ${${formation_controller_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${formation_controller_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
