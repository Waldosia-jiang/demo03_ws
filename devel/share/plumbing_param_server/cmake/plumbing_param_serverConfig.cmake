...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_param_server_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/plumbing_param_server)
  set(plumbing_param_server_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(plumbing_param_server_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_param_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/plumbing_param_server/${idir}'.  ${_report}")
    endif()
