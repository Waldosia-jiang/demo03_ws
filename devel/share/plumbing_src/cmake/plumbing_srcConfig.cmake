...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_src_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/plumbing_src)
  set(plumbing_src_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(plumbing_src_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_src' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/plumbing_src/${idir}'.  ${_report}")
    endif()
