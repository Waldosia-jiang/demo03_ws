...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_controllers_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_controllers)
  set(arbotix_controllers_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(arbotix_controllers_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_controllers/${idir}'.  ${_report}")
    endif()
