...
if(icar_msgs_CONFIG_INCLUDED)
  return()
endif()
set(icar_msgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(icar_msgs_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/icar_multi/icar/icar_msgs)
  set(icar_msgs_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  set(icar_msgs_INSTALL_PREFIX "")
  set(icar_msgs_PREFIX ${icar_msgs_DEVEL_PREFIX})
else()
  set(icar_msgs_SOURCE_PREFIX "")
  set(icar_msgs_DEVEL_PREFIX "")
  set(icar_msgs_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
  set(icar_msgs_PREFIX ${icar_msgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'icar_msgs' is deprecated")
...
set(icar_msgs_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/wheeltec/demo03_ws/devel/include " STREQUAL " ")
  set(icar_msgs_INCLUDE_DIRS "")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'weki <weki@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${icar_msgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'icar_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'icar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/icar_multi/icar/icar_msgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(icar_msgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND icar_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND icar_msgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT icar_msgs_NUM_DUMMY_TARGETS)
      set(icar_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::icar_msgs::wrapped-linker-option${icar_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR icar_msgs_NUM_DUMMY_TARGETS "${icar_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::icar_msgs::wrapped-linker-option${icar_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND icar_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(icar_msgs_LIBRARY_DIRS ${lib_path})
      list(APPEND icar_msgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'icar_msgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND icar_msgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(icar_msgs_EXPORTED_TARGETS "icar_msgs_generate_messages_cpp;icar_msgs_generate_messages_eus;icar_msgs_generate_messages_lisp;icar_msgs_generate_messages_nodejs;icar_msgs_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${icar_msgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "message_generation;message_runtime;std_msgs;genmsg;actionlib_msgs;actionlib")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 icar_msgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${icar_msgs_dep}_FOUND)
      find_package(${icar_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${icar_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(icar_msgs_INCLUDE_DIRS ${${icar_msgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(icar_msgs_LIBRARIES ${icar_msgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${icar_msgs_dep}_LIBRARIES})
  _list_append_deduplicate(icar_msgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(icar_msgs_LIBRARIES ${icar_msgs_LIBRARIES})

  _list_append_unique(icar_msgs_LIBRARY_DIRS ${${icar_msgs_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(icar_msgs_EXPORTED_TARGETS ${${icar_msgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "icar_msgs-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${icar_msgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
