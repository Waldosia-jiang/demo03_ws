...
if(ros_04_plumbing_include_CONFIG_INCLUDED)
  return()
endif()
set(ros_04_plumbing_include_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ros_04_plumbing_include_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/ros_04_plumbing_include)
  set(ros_04_plumbing_include_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  set(ros_04_plumbing_include_INSTALL_PREFIX "")
  set(ros_04_plumbing_include_PREFIX ${ros_04_plumbing_include_DEVEL_PREFIX})
else()
  set(ros_04_plumbing_include_SOURCE_PREFIX "")
  set(ros_04_plumbing_include_DEVEL_PREFIX "")
  set(ros_04_plumbing_include_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
  set(ros_04_plumbing_include_PREFIX ${ros_04_plumbing_include_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ros_04_plumbing_include' is deprecated")
...
set(ros_04_plumbing_include_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(ros_04_plumbing_include_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ros_04_plumbing_include_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ros_04_plumbing_include' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ros_04_plumbing_include' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/ros_04_plumbing_include/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ros_04_plumbing_include_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ros_04_plumbing_include_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ros_04_plumbing_include_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ros_04_plumbing_include_NUM_DUMMY_TARGETS)
      set(ros_04_plumbing_include_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ros_04_plumbing_include::wrapped-linker-option${ros_04_plumbing_include_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ros_04_plumbing_include_NUM_DUMMY_TARGETS "${ros_04_plumbing_include_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ros_04_plumbing_include::wrapped-linker-option${ros_04_plumbing_include_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ros_04_plumbing_include_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ros_04_plumbing_include_LIBRARY_DIRS ${lib_path})
      list(APPEND ros_04_plumbing_include_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ros_04_plumbing_include'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ros_04_plumbing_include_LIBRARIES ${lib})
    endif()
  endif()
...
set(ros_04_plumbing_include_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ros_04_plumbing_include_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ros_04_plumbing_include_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ros_04_plumbing_include_dep}_FOUND)
      find_package(${ros_04_plumbing_include_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_04_plumbing_include_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ros_04_plumbing_include_INCLUDE_DIRS ${${ros_04_plumbing_include_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ros_04_plumbing_include_LIBRARIES ${ros_04_plumbing_include_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ros_04_plumbing_include_dep}_LIBRARIES})
  _list_append_deduplicate(ros_04_plumbing_include_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ros_04_plumbing_include_LIBRARIES ${ros_04_plumbing_include_LIBRARIES})

  _list_append_unique(ros_04_plumbing_include_LIBRARY_DIRS ${${ros_04_plumbing_include_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(ros_04_plumbing_include_EXPORTED_TARGETS ${${ros_04_plumbing_include_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ros_04_plumbing_include_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
