...
if(ros_05_01_04_muti_static_tf_CONFIG_INCLUDED)
  return()
endif()
set(ros_05_01_04_muti_static_tf_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ros_05_01_04_muti_static_tf_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/ros_05_01_04_muti_static_tf)
  set(ros_05_01_04_muti_static_tf_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  set(ros_05_01_04_muti_static_tf_INSTALL_PREFIX "")
  set(ros_05_01_04_muti_static_tf_PREFIX ${ros_05_01_04_muti_static_tf_DEVEL_PREFIX})
else()
  set(ros_05_01_04_muti_static_tf_SOURCE_PREFIX "")
  set(ros_05_01_04_muti_static_tf_DEVEL_PREFIX "")
  set(ros_05_01_04_muti_static_tf_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
  set(ros_05_01_04_muti_static_tf_PREFIX ${ros_05_01_04_muti_static_tf_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ros_05_01_04_muti_static_tf' is deprecated")
...
set(ros_05_01_04_muti_static_tf_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(ros_05_01_04_muti_static_tf_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ros_05_01_04_muti_static_tf_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ros_05_01_04_muti_static_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ros_05_01_04_muti_static_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/ros_05_01_04_muti_static_tf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ros_05_01_04_muti_static_tf_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ros_05_01_04_muti_static_tf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ros_05_01_04_muti_static_tf_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS)
      set(ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ros_05_01_04_muti_static_tf::wrapped-linker-option${ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS "${ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ros_05_01_04_muti_static_tf::wrapped-linker-option${ros_05_01_04_muti_static_tf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ros_05_01_04_muti_static_tf_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(ros_05_01_04_muti_static_tf_LIBRARY_DIRS ${lib_path})
      list(APPEND ros_05_01_04_muti_static_tf_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ros_05_01_04_muti_static_tf'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ros_05_01_04_muti_static_tf_LIBRARIES ${lib})
    endif()
  endif()
...
set(ros_05_01_04_muti_static_tf_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ros_05_01_04_muti_static_tf_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ros_05_01_04_muti_static_tf_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ros_05_01_04_muti_static_tf_dep}_FOUND)
      find_package(${ros_05_01_04_muti_static_tf_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_05_01_04_muti_static_tf_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ros_05_01_04_muti_static_tf_INCLUDE_DIRS ${${ros_05_01_04_muti_static_tf_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ros_05_01_04_muti_static_tf_LIBRARIES ${ros_05_01_04_muti_static_tf_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ros_05_01_04_muti_static_tf_dep}_LIBRARIES})
  _list_append_deduplicate(ros_05_01_04_muti_static_tf_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ros_05_01_04_muti_static_tf_LIBRARIES ${ros_05_01_04_muti_static_tf_LIBRARIES})

  _list_append_unique(ros_05_01_04_muti_static_tf_LIBRARY_DIRS ${${ros_05_01_04_muti_static_tf_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(ros_05_01_04_muti_static_tf_EXPORTED_TARGETS ${${ros_05_01_04_muti_static_tf_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ros_05_01_04_muti_static_tf_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
