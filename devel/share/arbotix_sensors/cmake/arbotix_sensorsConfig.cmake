...
if("TRUE" STREQUAL "TRUE")
  set(arbotix_sensors_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_sensors)
  set(arbotix_sensors_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(arbotix_sensors_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arbotix_sensors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/arbotix_ros/arbotix_sensors/${idir}'.  ${_report}")
    endif()
