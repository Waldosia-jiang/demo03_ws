...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_api_SOURCE_PREFIX /home/wheeltec/demo03_ws/src/plumbing_api)
  set(plumbing_api_DEVEL_PREFIX /home/wheeltec/demo03_ws/devel)
  ...
  set(plumbing_api_INSTALL_PREFIX /home/wheeltec/demo03_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_api' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/demo03_ws/src/plumbing_api/${idir}'.  ${_report}")
    endif()
